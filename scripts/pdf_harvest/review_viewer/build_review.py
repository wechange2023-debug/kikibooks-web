...
<div class="page">
 ...
 <div class="cols">
  ...
  <div class="col txt"><div class="v1">{esc(p1.get(pn, ""))}</div>
   <details><summary>v2 참고</summary><div class="v2">{esc(p2.get(pn, ""))}</div></details>
  </div>
 </div>
</div>""")
        doc.close()
...
<h1>Prong-2 사람검수 — v1 정본 후보 vs PDF 원본</h1>
<div class="guide">좌(PDF 원본 면)와 우(초록 상자 = <b>v1 정본 후보</b>)를 대조하세요.
단어 누락·뒤섞임·깨짐이 보이면 <b>[문제]</b> 체크 후 <b>slug + 면번호를 메모</b>해 주세요
(체크는 저장되지 않습니다). 회색 접이식 v2는 참고용입니다.</div>
<h2 id="toc">목차 (25권: MUST 1 · REVIEW 12 · AUTO 12)</h2>
<ul>{''.join(toc)}</ul>
{''.join(sections)}
</body></html>"""
