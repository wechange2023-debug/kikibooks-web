...
- **신규 발생 사항(진행 상태)**:
  ...
  - (s) ASb 뷰어 넘김 개선 트랙 착수 (2026-06-19): 4-viewport 검수 통과. 스와이프/키보드 넘김 부재 개선 결정. 의도=intent §8 신설, ADR-0025 Amd#7. 다음=asb-reader.tsx에 키보드+터치 핸들러+본문 alt 구현(코드 작업지시서 대기).
