...
| 항목 | v1 | v2 | v3 |
|---|---|---|---|
| phash 해밍거리 임계값 | 8 | 4 | **4** |
| 분석 대상 권수 | 1852 | 1805 | **1817** |
| 중복 그룹 수 | 194 | 160 | **166** |
| 중복으로 묶인 권수 | 453 | 347 | **362** |
| 유지 추천이 붙은 그룹 | 49 | 116 | **118** |
| 표지 오적재 후보 | — | 48 | **38** |

판정 기준: 바이트 동일 표지 + 제목 동일(`identical_file`) / phash 해밍거리 ≤ 4(`cover`) / 정규화 제목 유사도 ≥ 0.90(`title`)

유지 추천 우선순위: ① 오디오 보유(audio_books.csv) → ② book_dash → ③ 표지 해상도 최대 → 동률 시 팀장 판단

바이트 동일 표지 그룹 중 **제목이 다른** 건만 표지 오적재로 분리했다 → `cover_reload_candidates_v3.csv`

### v2 에서 끊겼던 관계 복원 검증

| 대상 | 결과 |
|---|---|
| Colours ×4 | ✅ 복원 — 그룹 3 · 4권 · matched_by=`identical_file+cover+title` |
| Luwo's House ×3 | ✅ 복원 — 그룹 17 · 3권 · matched_by=`identical_file+cover+title` |
| Disability Is Not Inability ×2 | ✅ 복원 — 그룹 64 · 2권 · matched_by=`identical_file+title` |
| They Can Do Many Things ×2 | ✅ 복원 — 그룹 150 · 2권 · matched_by=`identical_file+title` |

---

## 그룹 1 · 4권 · matched_by=`both`

| 표지 | 유지 | 제목 | 플랫폼 | 해상도 | 비고 | id |
|---|---|---|---|---|---|---|
...
## 그룹 3 · 4권 · matched_by=`identical_file+cover+title`
...
| [<img src="covers/8bd2abc7-78fa-4834-82e1-3f3d70122838.jpg" width="110">](https://s3.amazonaws.com/bloomharvest/cara_ediger%40sil-lead.org%2f86719656-00fb-416b-8482-793ccafe0364%2fbloomdigital%2fSWPB_95-colours-tell-me-now-series_Page_02_Image_0001.png) |  | Colours | bloom | 193200 |  | `8bd2abc7-78fa-4834-82e1-3f3d70122838` |
...
| [<img src="covers/e395f1f4-9a6a-4be6-bf47-c73673c663c2.jpg" width="110">](https://s3.amazonaws.com/bloomharvest/ernest_nniakyire%40gillbt.org%2fab1aea58-e2e4-443b-80a1-bddff931eb33%2fbloomdigital%2fSWPB_95-colours-tell-me-now-series_Page_02_Image_0001.png) |  | Colours | bloom | 193200 |  | `e395f1f4-9a6a-4be6-bf47-c73673c663c2` |

## 그룹 4 · 4권 · matched_by=`title`
...
## 그룹 17 · 3권 · matched_by=`identical_file+cover+title`

| 표지 | 유지 | 제목 | 플랫폼 | 해상도 | 비고 | id |
|---|---|---|---|---|---|---|
| [<img src="covers/75890d66-c900-43fb-bb5a-e2bfcffb58b7.jpg" width="110">](https://africanstorybook.org/illustrations/covers/32346.png) |  | Luwo's House | african_storybook | 38400 |  | `75890d66-c900-43fb-bb5a-e2bfcffb58b7` |
| [<img src="covers/8bccf2ed-1e2b-4706-a09b-8c977ecd8dc0.jpg" width="110">](https://s3.amazonaws.com/bloomharvest/1jWVbi8azo%2f1778675736419%2fbloomdigital%2fLuwo%2011.jpg) |  | Luwo's House | bloom | 575280 |  | `8bccf2ed-1e2b-4706-a09b-8c977ecd8dc0` |
| [<img src="covers/3d352d10-a692-4a1f-a648-7d600dbb49c3.jpg" width="110">](https://s3.amazonaws.com/bloomharvest/K76ltcXrob%2f1779888679075%2fbloomdigital%2fLuwo%201.jpg) |  | Luwo’s House | bloom | 575280 |  | `3d352d10-a692-4a1f-a648-7d600dbb49c3` |
...
## 그룹 57 · 2권 · matched_by=`identical_file+cover+title`

| 표지 | 유지 | 제목 | 플랫폼 | 해상도 | 비고 | id |
|---|---|---|---|---|---|---|
| [<img src="covers/31617e8a-708e-4718-b2cf-c7e95e3f697c.jpg" width="110">](https://s3.amazonaws.com/bloomharvest/okuukeremetbooks%40gmail.com%2fade8e83d-9b2a-4bd5-8404-e0a4385a9113%2fbloomdigital%2fSWPB_114-colours-of-nature_Page_02_Image_0001.png) |  | Colours of Nature | bloom | 193200 |  | `31617e8a-708e-4718-b2cf-c7e95e3f697c` |
| [<img src="covers/eb1af9d3-cda7-4725-8ac7-5ecf9620b871.jpg" width="110">](https://s3.amazonaws.com/bloomharvest/cara_ediger%40sil-lead.org%2f1b7a882c-9de5-49e5-af0a-007b7d315d3c%2fbloomdigital%2fSWPB_114-colours-of-nature_Page_02_Image_0001.png) |  | Colours of Nature | bloom | 193200 |  | `eb1af9d3-cda7-4725-8ac7-5ecf9620b871` |
...
## 그룹 64 · 2권 · matched_by=`identical_file+title`

| 표지 | 유지 | 제목 | 플랫폼 | 해상도 | 비고 | id |
|---|---|---|---|---|---|---|
| [<img src="covers/bd4f2477-69ac-477a-9705-6b80f8b49367.jpg" width="110">](https://content.digitallibrary.io/wp-content/uploads/2022/03/httpsdigitallibrary.iowp-contentuploads20201014505-7c82e3c3967af7cd0fc0bc6c6c18d468-0b9cefec62fd3118a6578d97b0824c26.jpg) | **Y**<br>최대 해상도 (표지 오적재 판 제외) | Disability Is Not Inability | gdl | 345600 |  | `bd4f2477-69ac-477a-9705-6b80f8b49367` |
| [<img src="covers/d097ab0b-754d-4dd6-9a78-a60235914dfb.jpg" width="110">](https://s3.amazonaws.com/bloomharvest/farhad%40foundationsduhok.com%2fb700877a-f0e4-483b-8e9a-e1b4cd726022%2fbloomdigital%2fimage2.jpg) |  | Disability is not inability | bloom | 358200 | ⚠️ 표지 재적재 필요 | `d097ab0b-754d-4dd6-9a78-a60235914dfb` |

## 그룹 65 · 2권 · matched_by=`cover`
...
## 그룹 130 · 2권 · matched_by=`identical_file+cover+title`

| 표지 | 유지 | 제목 | 플랫폼 | 해상도 | 비고 | id |
|---|---|---|---|---|---|---|
| [<img src="covers/15feb865-75a8-4bad-81ba-4adf9f3ab7f4.jpg" width="110">](https://africanstorybook.org/illustrations/covers/35250.png) |  | Sara's Canoe | african_storybook | 38400 |  | `15feb865-75a8-4bad-81ba-4adf9f3ab7f4` |
| [<img src="covers/f2cf58ee-fb49-4660-a359-28f77bbd0db8.jpg" width="110">](https://africanstorybook.org/illustrations/covers/35255.png) |  | Sara's Canoe | african_storybook | 38400 |  | `f2cf58ee-fb49-4660-a359-28f77bbd0db8` |
...
## 그룹 136 · 2권 · matched_by=`identical_file+cover+title`

| 표지 | 유지 | 제목 | 플랫폼 | 해상도 | 비고 | id |
|---|---|---|---|---|---|---|
| [<img src="covers/3f09c4cd-9b0a-421d-bacd-09c74cf7efe7.jpg" width="110">](https://content.digitallibrary.io/wp-content/uploads/2023/04/34977-02a526e3718a8a48210b48220f03776d-coverImage.jpeg) |  | Sister, Sister, Why Don't Things Fall Up? | gdl | 905296 |  | `3f09c4cd-9b0a-421d-bacd-09c74cf7efe7` |
| [<img src="covers/14b63f32-f767-4af5-9fb8-df4e333828e3.jpg" width="110">](https://content.digitallibrary.io/wp-content/uploads/2023/04/36171-02a526e3718a8a48210b48220f03776d-coverImage.jpeg) |  | Sister, Sister, Why Don’t Things Fall Up? | gdl | 905296 |  | `14b63f32-f767-4af5-9fb8-df4e333828e3` |
...
## 그룹 150 · 2권 · matched_by=`identical_file+title`

| 표지 | 유지 | 제목 | 플랫폼 | 해상도 | 비고 | id |
|---|---|---|---|---|---|---|
| [<img src="covers/0c26d08b-7e8b-434d-88a0-2e542c45d61f.jpg" width="110">](https://s3.amazonaws.com/bloomharvest/lohorungkushal%40gmail.com%2f985f9b3a-bd32-4eaa-938a-a47c694c1ad7%2fbloomdigital%2fimage1.jpg) | **Y**<br>최대 해상도 (표지 오적재 판 제외) | They Can Do Many Things | bloom | 358801 |  | `0c26d08b-7e8b-434d-88a0-2e542c45d61f` |
| [<img src="covers/98ea493b-9d0f-445f-94b1-58ec6939d8cf.jpg" width="110">](https://s3.amazonaws.com/bloomharvest/bethann_carlson%40sil.org%2f8512c734-aac8-4424-9b3e-02effb605e2b%2fbloomdigital%2fimage2.jpg) |  | They Can Do Many Things | bloom | 358200 | ⚠️ 표지 재적재 필요 | `98ea493b-9d0f-445f-94b1-58ec6939d8cf` |
